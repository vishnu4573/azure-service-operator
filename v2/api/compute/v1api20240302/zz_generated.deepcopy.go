...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CommonUserAssignedIdentitiesValue_STATUS) DeepCopyInto(out *CommonUserAssignedIdentitiesValue_STATUS) {
	*out = *in
	if in.ClientId != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CommonUserAssignedIdentitiesValue_STATUS.
func (in *CommonUserAssignedIdentitiesValue_STATUS) DeepCopy() *CommonUserAssignedIdentitiesValue_STATUS {
	if in == nil {
		return nil
	}
	out := new(CommonUserAssignedIdentitiesValue_STATUS)
	in.DeepCopyInto(out)
	return out
}
...
func (in *Disk_STATUS) DeepCopyInto(out *Disk_STATUS) {
	*out = *in
	...
	if in.HyperVGeneration != nil {
		...
		*out = new(CommonHyperVGeneration_STATUS)
		**out = **in
	}
	if in.Id != nil {
		in, out := &in.Id, &out.Id
	...
	if in.OsType != nil {
		...
		*out = new(CommonOperatingSystemTypes_STATUS)
		**out = **in
	}
...
func (in *Disk_Spec) DeepCopyInto(out *Disk_Spec) {
	*out = *in
	...
	if in.HyperVGeneration != nil {
		in, out := &in.HyperVGeneration, &out.HyperVGeneration
		*out = new(CommonHyperVGeneration)
		**out = **in
	}
	if in.Location != nil {
		in, out := &in.Location, &out.Location
	...
	if in.OsType != nil {
		in, out := &in.OsType, &out.OsType
		*out = new(CommonOperatingSystemTypes)
		**out = **in
	}
	if in.Owner != nil {
		in, out := &in.Owner, &out.Owner
...
func (in *EncryptionSetIdentity_STATUS) DeepCopyInto(out *EncryptionSetIdentity_STATUS) {
	*out = *in
	...
	if in.UserAssignedIdentities != nil {
		in, out := &in.UserAssignedIdentities, &out.UserAssignedIdentities
		*out = make(map[string]CommonUserAssignedIdentitiesValue_STATUS, len(*in))
		for key, val := range *in {
...
func (in *SupportedCapabilities_STATUS) DeepCopyInto(out *SupportedCapabilities_STATUS) {
	*out = *in
	...
	if in.Architecture != nil {
		in, out := &in.Architecture, &out.Architecture
		*out = new(CommonArchitecture_STATUS)
		**out = **in
	}
	if in.DiskControllerTypes != nil {
		in, out := &in.DiskControllerTypes, &out.DiskControllerTypes
