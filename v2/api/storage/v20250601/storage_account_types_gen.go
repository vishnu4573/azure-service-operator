...
func (account *StorageAccount_Spec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if account.Placement != nil {
		placement_ARM, err := account.Placement.ConvertToARM(resolved)
		if err != nil {
			return nil, err
		}
		placement := *placement_ARM.(*arm.Placement)
	...
	if account.AccessTier != nil ||
		...
		account.DualStackEndpointPreference != nil ||
		account.EnableExtendedGroups != nil ||
		account.Encryption != nil ||
		account.GeoPriorityReplicationStatus != nil ||
	...
	if account.AccessTier != nil {
		...
		accessTier := arm.AccessTier(temp)
	...
	if account.AllowedCopyScope != nil {
		...
		allowedCopyScope := arm.AllowedCopyScope(temp)
	...
	if account.DnsEndpointType != nil {
		...
		dnsEndpointType := arm.DnsEndpointType(temp)
		result.Properties.DnsEndpointType = &dnsEndpointType
	}
	if account.DualStackEndpointPreference != nil {
		dualStackEndpointPreference_ARM, err := account.DualStackEndpointPreference.ConvertToARM(resolved)
		if err != nil {
			return nil, err
		}
		dualStackEndpointPreference := *dualStackEndpointPreference_ARM.(*arm.DualStackEndpointPreference)
		result.Properties.DualStackEndpointPreference = &dualStackEndpointPreference
	}
	if account.EnableExtendedGroups != nil {
		enableExtendedGroups := *account.EnableExtendedGroups
		result.Properties.EnableExtendedGroups = &enableExtendedGroups
	}
	...
	if account.GeoPriorityReplicationStatus != nil {
		geoPriorityReplicationStatus_ARM, err := account.GeoPriorityReplicationStatus.ConvertToARM(resolved)
		if err != nil {
			return nil, err
		}
		geoPriorityReplicationStatus := *geoPriorityReplicationStatus_ARM.(*arm.GeoPriorityReplicationStatus)
		result.Properties.GeoPriorityReplicationStatus = &geoPriorityReplicationStatus
	}
	...
	if account.LargeFileSharesState != nil {
		...
		largeFileSharesState := arm.LargeFileSharesState(temp)
	...
	if account.MinimumTlsVersion != nil {
		...
		minimumTlsVersion := arm.MinimumTlsVersion(temp)
	...
	// Set property "Zones":
	for _, item := range account.Zones {
...
func (account *StorageAccount_Spec) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.AllowedCopyScope != nil {
			...
			allowedCopyScope := AllowedCopyScope(temp)
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.DnsEndpointType != nil {
			...
			dnsEndpointType := DnsEndpointType(temp)
			account.DnsEndpointType = &dnsEndpointType
		}
	}

	// Set property "DualStackEndpointPreference":
	// copying flattened property:
	if typedInput.Properties != nil {
		if typedInput.Properties.DualStackEndpointPreference != nil {
			var dualStackEndpointPreference1 DualStackEndpointPreference
			err := dualStackEndpointPreference1.PopulateFromARM(owner, *typedInput.Properties.DualStackEndpointPreference)
			if err != nil {
				return err
			}
			dualStackEndpointPreference := dualStackEndpointPreference1
			account.DualStackEndpointPreference = &dualStackEndpointPreference
		}
	}

	// Set property "EnableExtendedGroups":
	// copying flattened property:
	if typedInput.Properties != nil {
		if typedInput.Properties.EnableExtendedGroups != nil {
			enableExtendedGroups := *typedInput.Properties.EnableExtendedGroups
			account.EnableExtendedGroups = &enableExtendedGroups
		}
	}
	...
	// Set property "GeoPriorityReplicationStatus":
	// copying flattened property:
	if typedInput.Properties != nil {
		if typedInput.Properties.GeoPriorityReplicationStatus != nil {
			var geoPriorityReplicationStatus1 GeoPriorityReplicationStatus
			err := geoPriorityReplicationStatus1.PopulateFromARM(owner, *typedInput.Properties.GeoPriorityReplicationStatus)
			if err != nil {
				return err
			}
			geoPriorityReplicationStatus := geoPriorityReplicationStatus1
			account.GeoPriorityReplicationStatus = &geoPriorityReplicationStatus
		}
	}
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.LargeFileSharesState != nil {
			...
			largeFileSharesState := LargeFileSharesState(temp)
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.MinimumTlsVersion != nil {
			...
			minimumTlsVersion := MinimumTlsVersion(temp)
	...
	if typedInput.Placement != nil {
		...
		err := placement1.PopulateFromARM(owner, *typedInput.Placement)
		if err != nil {
			return err
		}
	...
	for _, item := range typedInput.Zones {
		account.Zones = append(account.Zones, item)
	}
...
func (account *StorageAccount_Spec) AssignProperties_From_StorageAccount_Spec(source *storage.StorageAccount_Spec) error {
	...
	if source.AccessTier != nil {
		...
		accessTierTemp := genruntime.ToEnum(accessTier, accessTier_Values)
	...
	if source.AllowedCopyScope != nil {
		...
		allowedCopyScopeTemp := genruntime.ToEnum(allowedCopyScope, allowedCopyScope_Values)
	...
	if source.DnsEndpointType != nil {
		...
		dnsEndpointTypeTemp := genruntime.ToEnum(dnsEndpointType, dnsEndpointType_Values)
	...
	if source.DualStackEndpointPreference != nil {
		...
		err := dualStackEndpointPreference.AssignProperties_From_DualStackEndpointPreference(source.DualStackEndpointPreference)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_DualStackEndpointPreference() to populate field DualStackEndpointPreference")
		}
		account.DualStackEndpointPreference = &dualStackEndpointPreference
	} else {
		account.DualStackEndpointPreference = nil
	...
	if source.EnableExtendedGroups != nil {
		enableExtendedGroup := *source.EnableExtendedGroups
		account.EnableExtendedGroups = &enableExtendedGroup
	} else {
		account.EnableExtendedGroups = nil
	}
	...
	if source.GeoPriorityReplicationStatus != nil {
		var geoPriorityReplicationStatus GeoPriorityReplicationStatus
		err := geoPriorityReplicationStatus.AssignProperties_From_GeoPriorityReplicationStatus(source.GeoPriorityReplicationStatus)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_GeoPriorityReplicationStatus() to populate field GeoPriorityReplicationStatus")
		}
		account.GeoPriorityReplicationStatus = &geoPriorityReplicationStatus
	} else {
		account.GeoPriorityReplicationStatus = nil
	...
	if source.LargeFileSharesState != nil {
		...
		largeFileSharesStateTemp := genruntime.ToEnum(largeFileSharesState, largeFileSharesState_Values)
	...
	if source.MinimumTlsVersion != nil {
		...
		minimumTlsVersionTemp := genruntime.ToEnum(minimumTlsVersion, minimumTlsVersion_Values)
	...
	if source.Placement != nil {
		...
		err := placement.AssignProperties_From_Placement(source.Placement)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_Placement() to populate field Placement")
		}
		account.Placement = &placement
	} else {
		account.Placement = nil
	}
	...
	// Zones
	account.Zones = genruntime.CloneSliceOfString(source.Zones)
...
func (account *StorageAccount_Spec) AssignProperties_To_StorageAccount_Spec(destination *storage.StorageAccount_Spec) error {
	...
	if account.DualStackEndpointPreference != nil {
		...
		err := account.DualStackEndpointPreference.AssignProperties_To_DualStackEndpointPreference(&dualStackEndpointPreference)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_DualStackEndpointPreference() to populate field DualStackEndpointPreference")
		}
	...
	// EnableExtendedGroups
	if account.EnableExtendedGroups != nil {
		enableExtendedGroup := *account.EnableExtendedGroups
	...
	if account.GeoPriorityReplicationStatus != nil {
		...
		err := account.GeoPriorityReplicationStatus.AssignProperties_To_GeoPriorityReplicationStatus(&geoPriorityReplicationStatus)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_GeoPriorityReplicationStatus() to populate field GeoPriorityReplicationStatus")
		}
	...
	if account.Placement != nil {
		...
		err := account.Placement.AssignProperties_To_Placement(&placement)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_Placement() to populate field Placement")
		}
	...
	// Zones
	destination.Zones = genruntime.CloneSliceOfString(account.Zones)
...
func (account *StorageAccount_Spec) Initialize_From_StorageAccount_STATUS(source *StorageAccount_STATUS) error {
	...
	// AccessTier
	if source.AccessTier != nil {
		accessTier := genruntime.ToEnum(string(*source.AccessTier), accessTier_Values)
		account.AccessTier = &accessTier
	} else {
		account.AccessTier = nil
	}
	...
	// AllowedCopyScope
	if source.AllowedCopyScope != nil {
		allowedCopyScope := genruntime.ToEnum(string(*source.AllowedCopyScope), allowedCopyScope_Values)
		account.AllowedCopyScope = &allowedCopyScope
	} else {
		account.AllowedCopyScope = nil
	}
	...
	// DnsEndpointType
	if source.DnsEndpointType != nil {
		dnsEndpointType := genruntime.ToEnum(string(*source.DnsEndpointType), dnsEndpointType_Values)
		account.DnsEndpointType = &dnsEndpointType
	} else {
		account.DnsEndpointType = nil
	}
	...
	if source.DualStackEndpointPreference != nil {
		var dualStackEndpointPreference DualStackEndpointPreference
		err := dualStackEndpointPreference.Initialize_From_DualStackEndpointPreference_STATUS(source.DualStackEndpointPreference)
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_DualStackEndpointPreference_STATUS() to populate field DualStackEndpointPreference")
		}
		account.DualStackEndpointPreference = &dualStackEndpointPreference
	} else {
		account.DualStackEndpointPreference = nil
	...
	if source.GeoPriorityReplicationStatus != nil {
		var geoPriorityReplicationStatus GeoPriorityReplicationStatus
		err := geoPriorityReplicationStatus.Initialize_From_GeoPriorityReplicationStatus_STATUS(source.GeoPriorityReplicationStatus)
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_GeoPriorityReplicationStatus_STATUS() to populate field GeoPriorityReplicationStatus")
		}
		account.GeoPriorityReplicationStatus = &geoPriorityReplicationStatus
	} else {
		account.GeoPriorityReplicationStatus = nil
	...
	// LargeFileSharesState
	if source.LargeFileSharesState != nil {
		largeFileSharesState := genruntime.ToEnum(string(*source.LargeFileSharesState), largeFileSharesState_Values)
		account.LargeFileSharesState = &largeFileSharesState
	} else {
		account.LargeFileSharesState = nil
	}
	...
	// MinimumTlsVersion
	if source.MinimumTlsVersion != nil {
		minimumTlsVersion := genruntime.ToEnum(string(*source.MinimumTlsVersion), minimumTlsVersion_Values)
		account.MinimumTlsVersion = &minimumTlsVersion
	} else {
		account.MinimumTlsVersion = nil
	}
	...
	if source.Placement != nil {
		var placement Placement
		err := placement.Initialize_From_Placement_STATUS(source.Placement)
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_Placement_STATUS() to populate field Placement")
		}
		account.Placement = &placement
	} else {
		account.Placement = nil
...
func (account *StorageAccount_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.AccessTier != nil {
			var temp string
			temp = string(*typedInput.Properties.AccessTier)
			accessTier := AccessTier_STATUS(temp)
			account.AccessTier = &accessTier
		}
	}
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.AllowedCopyScope != nil {
			var temp string
			temp = string(*typedInput.Properties.AllowedCopyScope)
			allowedCopyScope := AllowedCopyScope_STATUS(temp)
			account.AllowedCopyScope = &allowedCopyScope
		}
	}
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.DnsEndpointType != nil {
			var temp string
			temp = string(*typedInput.Properties.DnsEndpointType)
			dnsEndpointType := DnsEndpointType_STATUS(temp)
			account.DnsEndpointType = &dnsEndpointType
		}
	}
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.DualStackEndpointPreference != nil {
			var dualStackEndpointPreference1 DualStackEndpointPreference_STATUS
			err := dualStackEndpointPreference1.PopulateFromARM(owner, *typedInput.Properties.DualStackEndpointPreference)
			if err != nil {
				return err
			}
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.GeoPriorityReplicationStatus != nil {
			var geoPriorityReplicationStatus1 GeoPriorityReplicationStatus_STATUS
			err := geoPriorityReplicationStatus1.PopulateFromARM(owner, *typedInput.Properties.GeoPriorityReplicationStatus)
			if err != nil {
				return err
			}
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.LargeFileSharesState != nil {
			var temp string
			temp = string(*typedInput.Properties.LargeFileSharesState)
			largeFileSharesState := LargeFileSharesState_STATUS(temp)
			account.LargeFileSharesState = &largeFileSharesState
		}
	}
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.MinimumTlsVersion != nil {
			var temp string
			temp = string(*typedInput.Properties.MinimumTlsVersion)
			minimumTlsVersion := MinimumTlsVersion_STATUS(temp)
			account.MinimumTlsVersion = &minimumTlsVersion
		}
	}
	...
	// Set property "Placement":
	if typedInput.Placement != nil {
		var placement1 Placement_STATUS
		err := placement1.PopulateFromARM(owner, *typedInput.Placement)
		if err != nil {
			return err
		}
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.StatusOfPrimary != nil {
			...
			statusOfPrimary := AccountStatus_STATUS(temp)
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.StatusOfSecondary != nil {
			...
			statusOfSecondary := AccountStatus_STATUS(temp)
...
func (account *StorageAccount_STATUS) AssignProperties_From_StorageAccount_STATUS(source *storage.StorageAccount_STATUS) error {
	...
	if source.AccessTier != nil {
		accessTier := *source.AccessTier
		accessTierTemp := genruntime.ToEnum(accessTier, accessTier_STATUS_Values)
		account.AccessTier = &accessTierTemp
	} else {
		account.AccessTier = nil
	}
	...
	if source.AllowedCopyScope != nil {
		allowedCopyScope := *source.AllowedCopyScope
		allowedCopyScopeTemp := genruntime.ToEnum(allowedCopyScope, allowedCopyScope_STATUS_Values)
		account.AllowedCopyScope = &allowedCopyScopeTemp
	} else {
		account.AllowedCopyScope = nil
	}
	...
	if source.DnsEndpointType != nil {
		dnsEndpointType := *source.DnsEndpointType
		dnsEndpointTypeTemp := genruntime.ToEnum(dnsEndpointType, dnsEndpointType_STATUS_Values)
		account.DnsEndpointType = &dnsEndpointTypeTemp
	} else {
		account.DnsEndpointType = nil
	}
	...
	// DualStackEndpointPreference
	if source.DualStackEndpointPreference != nil {
		var dualStackEndpointPreference DualStackEndpointPreference_STATUS
		err := dualStackEndpointPreference.AssignProperties_From_DualStackEndpointPreference_STATUS(source.DualStackEndpointPreference)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_DualStackEndpointPreference_STATUS() to populate field DualStackEndpointPreference")
		}
		account.DualStackEndpointPreference = &dualStackEndpointPreference
	} else {
		account.DualStackEndpointPreference = nil
	...
	// GeoPriorityReplicationStatus
	if source.GeoPriorityReplicationStatus != nil {
		var geoPriorityReplicationStatus GeoPriorityReplicationStatus_STATUS
		err := geoPriorityReplicationStatus.AssignProperties_From_GeoPriorityReplicationStatus_STATUS(source.GeoPriorityReplicationStatus)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_GeoPriorityReplicationStatus_STATUS() to populate field GeoPriorityReplicationStatus")
		}
		account.GeoPriorityReplicationStatus = &geoPriorityReplicationStatus
	} else {
		account.GeoPriorityReplicationStatus = nil
	...
	if source.LargeFileSharesState != nil {
		largeFileSharesState := *source.LargeFileSharesState
		largeFileSharesStateTemp := genruntime.ToEnum(largeFileSharesState, largeFileSharesState_STATUS_Values)
		account.LargeFileSharesState = &largeFileSharesStateTemp
	} else {
		account.LargeFileSharesState = nil
	}
	...
	if source.MinimumTlsVersion != nil {
		minimumTlsVersion := *source.MinimumTlsVersion
		minimumTlsVersionTemp := genruntime.ToEnum(minimumTlsVersion, minimumTlsVersion_STATUS_Values)
		account.MinimumTlsVersion = &minimumTlsVersionTemp
	} else {
		account.MinimumTlsVersion = nil
	}
	...
	// Placement
	if source.Placement != nil {
		var placement Placement_STATUS
		err := placement.AssignProperties_From_Placement_STATUS(source.Placement)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_Placement_STATUS() to populate field Placement")
		}
		account.Placement = &placement
	} else {
		account.Placement = nil
	...
	if source.StatusOfPrimary != nil {
		...
		statusOfPrimaryTemp := genruntime.ToEnum(statusOfPrimary, accountStatus_STATUS_Values)
	...
	if source.StatusOfSecondary != nil {
		...
		statusOfSecondaryTemp := genruntime.ToEnum(statusOfSecondary, accountStatus_STATUS_Values)
...
func (account *StorageAccount_STATUS) AssignProperties_To_StorageAccount_STATUS(destination *storage.StorageAccount_STATUS) error {
	...
	if account.DualStackEndpointPreference != nil {
		...
		err := account.DualStackEndpointPreference.AssignProperties_To_DualStackEndpointPreference_STATUS(&dualStackEndpointPreference)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_DualStackEndpointPreference_STATUS() to populate field DualStackEndpointPreference")
		}
		destination.DualStackEndpointPreference = &dualStackEndpointPreference
	} else {
		destination.DualStackEndpointPreference = nil
	...
	if account.GeoPriorityReplicationStatus != nil {
		...
		err := account.GeoPriorityReplicationStatus.AssignProperties_To_GeoPriorityReplicationStatus_STATUS(&geoPriorityReplicationStatus)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_GeoPriorityReplicationStatus_STATUS() to populate field GeoPriorityReplicationStatus")
		}
		destination.GeoPriorityReplicationStatus = &geoPriorityReplicationStatus
	} else {
		destination.GeoPriorityReplicationStatus = nil
	...
	if account.Placement != nil {
		...
		err := account.Placement.AssignProperties_To_Placement_STATUS(&placement)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_Placement_STATUS() to populate field Placement")
		}
		destination.Placement = &placement
	} else {
		destination.Placement = nil
...
func (authentication *AzureFilesIdentityBasedAuthentication) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if authentication.DefaultSharePermission != nil {
		...
		defaultSharePermission := arm.DefaultSharePermission(temp)
	...
	if authentication.DirectoryServiceOptions != nil {
		...
		directoryServiceOptions := arm.DirectoryServiceOptions(temp)
		result.DirectoryServiceOptions = &directoryServiceOptions
	}

	// Set property "SmbOAuthSettings":
	if authentication.SmbOAuthSettings != nil {
		smbOAuthSettings_ARM, err := authentication.SmbOAuthSettings.ConvertToARM(resolved)
		if err != nil {
			return nil, err
		}
		smbOAuthSettings := *smbOAuthSettings_ARM.(*arm.SmbOAuthSettings)
		result.SmbOAuthSettings = &smbOAuthSettings
	}
	return result, nil
}
...
func (authentication *AzureFilesIdentityBasedAuthentication) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.DefaultSharePermission != nil {
		...
		defaultSharePermission := DefaultSharePermission(temp)
	...
	if typedInput.DirectoryServiceOptions != nil {
		...
		directoryServiceOptions := DirectoryServiceOptions(temp)
		authentication.DirectoryServiceOptions = &directoryServiceOptions
	}

	// Set property "SmbOAuthSettings":
	if typedInput.SmbOAuthSettings != nil {
		var smbOAuthSettings1 SmbOAuthSettings
		err := smbOAuthSettings1.PopulateFromARM(owner, *typedInput.SmbOAuthSettings)
		if err != nil {
			return err
		}
		smbOAuthSettings := smbOAuthSettings1
		authentication.SmbOAuthSettings = &smbOAuthSettings
	}
...
func (authentication *AzureFilesIdentityBasedAuthentication) AssignProperties_From_AzureFilesIdentityBasedAuthentication(source *storage.AzureFilesIdentityBasedAuthentication) error {
	...
	if source.DefaultSharePermission != nil {
		...
		defaultSharePermissionTemp := genruntime.ToEnum(defaultSharePermission, defaultSharePermission_Values)
	...
	if source.DirectoryServiceOptions != nil {
		...
		directoryServiceOptionTemp := genruntime.ToEnum(directoryServiceOption, directoryServiceOptions_Values)
	...
	if source.SmbOAuthSettings != nil {
		var smbOAuthSetting SmbOAuthSettings
		err := smbOAuthSetting.AssignProperties_From_SmbOAuthSettings(source.SmbOAuthSettings)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_SmbOAuthSettings() to populate field SmbOAuthSettings")
		}
		authentication.SmbOAuthSettings = &smbOAuthSetting
	} else {
		authentication.SmbOAuthSettings = nil
	}
...
func (authentication *AzureFilesIdentityBasedAuthentication) AssignProperties_To_AzureFilesIdentityBasedAuthentication(destination *storage.AzureFilesIdentityBasedAuthentication) error {
	...
	if authentication.SmbOAuthSettings != nil {
		...
		err := authentication.SmbOAuthSettings.AssignProperties_To_SmbOAuthSettings(&smbOAuthSetting)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_SmbOAuthSettings() to populate field SmbOAuthSettings")
		}
...
func (authentication *AzureFilesIdentityBasedAuthentication) Initialize_From_AzureFilesIdentityBasedAuthentication_STATUS(source *AzureFilesIdentityBasedAuthentication_STATUS) error {
	...
	// DefaultSharePermission
	if source.DefaultSharePermission != nil {
		defaultSharePermission := genruntime.ToEnum(string(*source.DefaultSharePermission), defaultSharePermission_Values)
		authentication.DefaultSharePermission = &defaultSharePermission
	} else {
		authentication.DefaultSharePermission = nil
	}
	...
	// DirectoryServiceOptions
	if source.DirectoryServiceOptions != nil {
		directoryServiceOption := genruntime.ToEnum(string(*source.DirectoryServiceOptions), directoryServiceOptions_Values)
	...
	if source.SmbOAuthSettings != nil {
		var smbOAuthSetting SmbOAuthSettings
		err := smbOAuthSetting.Initialize_From_SmbOAuthSettings_STATUS(source.SmbOAuthSettings)
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_SmbOAuthSettings_STATUS() to populate field SmbOAuthSettings")
		}
		authentication.SmbOAuthSettings = &smbOAuthSetting
	} else {
		authentication.SmbOAuthSettings = nil
...
func (authentication *AzureFilesIdentityBasedAuthentication_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.DefaultSharePermission != nil {
		var temp string
		temp = string(*typedInput.DefaultSharePermission)
		defaultSharePermission := DefaultSharePermission_STATUS(temp)
		authentication.DefaultSharePermission = &defaultSharePermission
	}
	...
	if typedInput.DirectoryServiceOptions != nil {
		var temp string
		temp = string(*typedInput.DirectoryServiceOptions)
		directoryServiceOptions := DirectoryServiceOptions_STATUS(temp)
		authentication.DirectoryServiceOptions = &directoryServiceOptions
	}

	// Set property "SmbOAuthSettings":
	if typedInput.SmbOAuthSettings != nil {
		var smbOAuthSettings1 SmbOAuthSettings_STATUS
		err := smbOAuthSettings1.PopulateFromARM(owner, *typedInput.SmbOAuthSettings)
		if err != nil {
			return err
		}
...
func (authentication *AzureFilesIdentityBasedAuthentication_STATUS) AssignProperties_From_AzureFilesIdentityBasedAuthentication_STATUS(source *storage.AzureFilesIdentityBasedAuthentication_STATUS) error {
	...
	if source.DefaultSharePermission != nil {
		defaultSharePermission := *source.DefaultSharePermission
		defaultSharePermissionTemp := genruntime.ToEnum(defaultSharePermission, defaultSharePermission_STATUS_Values)
		authentication.DefaultSharePermission = &defaultSharePermissionTemp
	} else {
		authentication.DefaultSharePermission = nil
	}
	...
	if source.DirectoryServiceOptions != nil {
		directoryServiceOption := *source.DirectoryServiceOptions
		directoryServiceOptionTemp := genruntime.ToEnum(directoryServiceOption, directoryServiceOptions_STATUS_Values)
		authentication.DirectoryServiceOptions = &directoryServiceOptionTemp
	} else {
		authentication.DirectoryServiceOptions = nil
	}
	...
	// SmbOAuthSettings
	if source.SmbOAuthSettings != nil {
		var smbOAuthSetting SmbOAuthSettings_STATUS
		err := smbOAuthSetting.AssignProperties_From_SmbOAuthSettings_STATUS(source.SmbOAuthSettings)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_SmbOAuthSettings_STATUS() to populate field SmbOAuthSettings")
		}
		authentication.SmbOAuthSettings = &smbOAuthSetting
	} else {
		authentication.SmbOAuthSettings = nil
...
func (authentication *AzureFilesIdentityBasedAuthentication_STATUS) AssignProperties_To_AzureFilesIdentityBasedAuthentication_STATUS(destination *storage.AzureFilesIdentityBasedAuthentication_STATUS) error {
	...
	if authentication.SmbOAuthSettings != nil {
		...
		err := authentication.SmbOAuthSettings.AssignProperties_To_SmbOAuthSettings_STATUS(&smbOAuthSetting)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_SmbOAuthSettings_STATUS() to populate field SmbOAuthSettings")
		}
		destination.SmbOAuthSettings = &smbOAuthSetting
	} else {
		destination.SmbOAuthSettings = nil
...
func (status *BlobRestoreStatus_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Status != nil {
		...
		status1 := BlobRestoreProgressStatus_STATUS(temp)
...
func (status *BlobRestoreStatus_STATUS) AssignProperties_From_BlobRestoreStatus_STATUS(source *storage.BlobRestoreStatus_STATUS) error {
	...
	if source.Status != nil {
		...
		statusTemp := genruntime.ToEnum(statusValue, blobRestoreProgressStatus_STATUS_Values)
...
var _ genruntime.ARMTransformer = &DualStackEndpointPreference{}

// ConvertToARM converts from a Kubernetes CRD object to an ARM object
func (preference *DualStackEndpointPreference) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	if preference == nil {
		return nil, nil
	}
	result := &arm.DualStackEndpointPreference{}

	// Set property "PublishIpv6Endpoint":
	if preference.PublishIpv6Endpoint != nil {
		publishIpv6Endpoint := *preference.PublishIpv6Endpoint
		result.PublishIpv6Endpoint = &publishIpv6Endpoint
	}
	return result, nil
}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (preference *DualStackEndpointPreference) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.DualStackEndpointPreference{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (preference *DualStackEndpointPreference) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.DualStackEndpointPreference)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.DualStackEndpointPreference, got %T", armInput)
	}

	// Set property "PublishIpv6Endpoint":
	if typedInput.PublishIpv6Endpoint != nil {
		publishIpv6Endpoint := *typedInput.PublishIpv6Endpoint
		preference.PublishIpv6Endpoint = &publishIpv6Endpoint
	}
...
// AssignProperties_From_DualStackEndpointPreference populates our DualStackEndpointPreference from the provided source DualStackEndpointPreference
func (preference *DualStackEndpointPreference) AssignProperties_From_DualStackEndpointPreference(source *storage.DualStackEndpointPreference) error {

	// PublishIpv6Endpoint
	if source.PublishIpv6Endpoint != nil {
		publishIpv6Endpoint := *source.PublishIpv6Endpoint
		preference.PublishIpv6Endpoint = &publishIpv6Endpoint
	} else {
		preference.PublishIpv6Endpoint = nil
	}
...
// AssignProperties_To_DualStackEndpointPreference populates the provided destination DualStackEndpointPreference from our DualStackEndpointPreference
func (preference *DualStackEndpointPreference) AssignProperties_To_DualStackEndpointPreference(destination *storage.DualStackEndpointPreference) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	if preference.PublishIpv6Endpoint != nil {
		publishIpv6Endpoint := *preference.PublishIpv6Endpoint
		destination.PublishIpv6Endpoint = &publishIpv6Endpoint
	} else {
		destination.PublishIpv6Endpoint = nil
	}
...
// Initialize_From_DualStackEndpointPreference_STATUS populates our DualStackEndpointPreference from the provided source DualStackEndpointPreference_STATUS
func (preference *DualStackEndpointPreference) Initialize_From_DualStackEndpointPreference_STATUS(source *DualStackEndpointPreference_STATUS) error {
...
var _ genruntime.FromARMConverter = &DualStackEndpointPreference_STATUS{}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (preference *DualStackEndpointPreference_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.DualStackEndpointPreference_STATUS{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (preference *DualStackEndpointPreference_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.DualStackEndpointPreference_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.DualStackEndpointPreference_STATUS, got %T", armInput)
	}
...
// AssignProperties_From_DualStackEndpointPreference_STATUS populates our DualStackEndpointPreference_STATUS from the provided source DualStackEndpointPreference_STATUS
func (preference *DualStackEndpointPreference_STATUS) AssignProperties_From_DualStackEndpointPreference_STATUS(source *storage.DualStackEndpointPreference_STATUS) error {
...
// AssignProperties_To_DualStackEndpointPreference_STATUS populates the provided destination DualStackEndpointPreference_STATUS from our DualStackEndpointPreference_STATUS
func (preference *DualStackEndpointPreference_STATUS) AssignProperties_To_DualStackEndpointPreference_STATUS(destination *storage.DualStackEndpointPreference_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (endpoints *Endpoints_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "Ipv6Endpoints":
	if typedInput.Ipv6Endpoints != nil {
		var ipv6Endpoints1 StorageAccountIpv6Endpoints_STATUS
		err := ipv6Endpoints1.PopulateFromARM(owner, *typedInput.Ipv6Endpoints)
		if err != nil {
			return err
		}
		ipv6Endpoints := ipv6Endpoints1
		endpoints.Ipv6Endpoints = &ipv6Endpoints
	}
...
func (endpoints *Endpoints_STATUS) AssignProperties_From_Endpoints_STATUS(source *storage.Endpoints_STATUS) error {
	...
	if source.Ipv6Endpoints != nil {
		var ipv6Endpoint StorageAccountIpv6Endpoints_STATUS
		err := ipv6Endpoint.AssignProperties_From_StorageAccountIpv6Endpoints_STATUS(source.Ipv6Endpoints)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_StorageAccountIpv6Endpoints_STATUS() to populate field Ipv6Endpoints")
		}
		endpoints.Ipv6Endpoints = &ipv6Endpoint
	} else {
		endpoints.Ipv6Endpoints = nil
	}
...
func (endpoints *Endpoints_STATUS) AssignProperties_To_Endpoints_STATUS(destination *storage.Endpoints_STATUS) error {
	...
	// Ipv6Endpoints
	if endpoints.Ipv6Endpoints != nil {
		var ipv6Endpoint storage.StorageAccountIpv6Endpoints_STATUS
		err := endpoints.Ipv6Endpoints.AssignProperties_To_StorageAccountIpv6Endpoints_STATUS(&ipv6Endpoint)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_StorageAccountIpv6Endpoints_STATUS() to populate field Ipv6Endpoints")
		}
...
func (location *ExtendedLocation) Initialize_From_ExtendedLocation_STATUS(source *ExtendedLocation_STATUS) error {
	...
	// Type
	if source.Type != nil {
		typeVar := genruntime.ToEnum(string(*source.Type), extendedLocationTypes_Values)
		location.Type = &typeVar
	} else {
		location.Type = nil
	}
...
var _ genruntime.ARMTransformer = &GeoPriorityReplicationStatus{}

// ConvertToARM converts from a Kubernetes CRD object to an ARM object
func (status *GeoPriorityReplicationStatus) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	if status == nil {
		return nil, nil
	}
	result := &arm.GeoPriorityReplicationStatus{}

	// Set property "IsBlobEnabled":
	if status.IsBlobEnabled != nil {
		isBlobEnabled := *status.IsBlobEnabled
		result.IsBlobEnabled = &isBlobEnabled
	}
	return result, nil
}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (status *GeoPriorityReplicationStatus) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.GeoPriorityReplicationStatus{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (status *GeoPriorityReplicationStatus) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.GeoPriorityReplicationStatus)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.GeoPriorityReplicationStatus, got %T", armInput)
	}

	// Set property "IsBlobEnabled":
	if typedInput.IsBlobEnabled != nil {
		isBlobEnabled := *typedInput.IsBlobEnabled
		status.IsBlobEnabled = &isBlobEnabled
	}
...
// AssignProperties_From_GeoPriorityReplicationStatus populates our GeoPriorityReplicationStatus from the provided source GeoPriorityReplicationStatus
func (status *GeoPriorityReplicationStatus) AssignProperties_From_GeoPriorityReplicationStatus(source *storage.GeoPriorityReplicationStatus) error {

	// IsBlobEnabled
	if source.IsBlobEnabled != nil {
		isBlobEnabled := *source.IsBlobEnabled
		status.IsBlobEnabled = &isBlobEnabled
	} else {
		status.IsBlobEnabled = nil
	}
...
// AssignProperties_To_GeoPriorityReplicationStatus populates the provided destination GeoPriorityReplicationStatus from our GeoPriorityReplicationStatus
func (status *GeoPriorityReplicationStatus) AssignProperties_To_GeoPriorityReplicationStatus(destination *storage.GeoPriorityReplicationStatus) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	if status.IsBlobEnabled != nil {
		isBlobEnabled := *status.IsBlobEnabled
		destination.IsBlobEnabled = &isBlobEnabled
	} else {
		destination.IsBlobEnabled = nil
	}
...
// Initialize_From_GeoPriorityReplicationStatus_STATUS populates our GeoPriorityReplicationStatus from the provided source GeoPriorityReplicationStatus_STATUS
func (status *GeoPriorityReplicationStatus) Initialize_From_GeoPriorityReplicationStatus_STATUS(source *GeoPriorityReplicationStatus_STATUS) error {
...
var _ genruntime.FromARMConverter = &GeoPriorityReplicationStatus_STATUS{}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (status *GeoPriorityReplicationStatus_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.GeoPriorityReplicationStatus_STATUS{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (status *GeoPriorityReplicationStatus_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.GeoPriorityReplicationStatus_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.GeoPriorityReplicationStatus_STATUS, got %T", armInput)
	}
...
// AssignProperties_From_GeoPriorityReplicationStatus_STATUS populates our GeoPriorityReplicationStatus_STATUS from the provided source GeoPriorityReplicationStatus_STATUS
func (status *GeoPriorityReplicationStatus_STATUS) AssignProperties_From_GeoPriorityReplicationStatus_STATUS(source *storage.GeoPriorityReplicationStatus_STATUS) error {
...
// AssignProperties_To_GeoPriorityReplicationStatus_STATUS populates the provided destination GeoPriorityReplicationStatus_STATUS from our GeoPriorityReplicationStatus_STATUS
func (status *GeoPriorityReplicationStatus_STATUS) AssignProperties_To_GeoPriorityReplicationStatus_STATUS(destination *storage.GeoPriorityReplicationStatus_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (stats *GeoReplicationStats_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.PostFailoverRedundancy != nil {
		...
		postFailoverRedundancy := PostFailoverRedundancy_STATUS(temp)
	...
	if typedInput.PostPlannedFailoverRedundancy != nil {
		...
		postPlannedFailoverRedundancy := PostPlannedFailoverRedundancy_STATUS(temp)
	...
	if typedInput.Status != nil {
		var temp string
		temp = string(*typedInput.Status)
		status := GeoReplicationStatus_STATUS(temp)
		stats.Status = &status
	}
...
func (stats *GeoReplicationStats_STATUS) AssignProperties_From_GeoReplicationStats_STATUS(source *storage.GeoReplicationStats_STATUS) error {
	...
	if source.PostFailoverRedundancy != nil {
		...
		postFailoverRedundancyTemp := genruntime.ToEnum(postFailoverRedundancy, postFailoverRedundancy_STATUS_Values)
	...
	if source.PostPlannedFailoverRedundancy != nil {
		...
		postPlannedFailoverRedundancyTemp := genruntime.ToEnum(postPlannedFailoverRedundancy, postPlannedFailoverRedundancy_STATUS_Values)
	...
	if source.Status != nil {
		...
		statusTemp := genruntime.ToEnum(status, geoReplicationStatus_STATUS_Values)
...
func (ruleSet *NetworkRuleSet) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	// Set property "Ipv6Rules":
	for _, item := range ruleSet.Ipv6Rules {
		item_ARM, err := item.ConvertToARM(resolved)
		if err != nil {
			return nil, err
		}
		result.Ipv6Rules = append(result.Ipv6Rules, *item_ARM.(*arm.IPRule))
	}
...
func (ruleSet *NetworkRuleSet) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "Ipv6Rules":
	for _, item := range typedInput.Ipv6Rules {
		var item1 IPRule
		err := item1.PopulateFromARM(owner, item)
		if err != nil {
			return err
		}
		ruleSet.Ipv6Rules = append(ruleSet.Ipv6Rules, item1)
	}
...
func (ruleSet *NetworkRuleSet) AssignProperties_From_NetworkRuleSet(source *storage.NetworkRuleSet) error {
	...
	// Ipv6Rules
	if source.Ipv6Rules != nil {
		ipv6RuleList := make([]IPRule, len(source.Ipv6Rules))
		for ipv6RuleIndex, ipv6RuleItem := range source.Ipv6Rules {
			var ipv6Rule IPRule
			err := ipv6Rule.AssignProperties_From_IPRule(&ipv6RuleItem)
			if err != nil {
				return eris.Wrap(err, "calling AssignProperties_From_IPRule() to populate field Ipv6Rules")
			}
			ipv6RuleList[ipv6RuleIndex] = ipv6Rule
		}
		ruleSet.Ipv6Rules = ipv6RuleList
	} else {
		ruleSet.Ipv6Rules = nil
	}
...
func (ruleSet *NetworkRuleSet) AssignProperties_To_NetworkRuleSet(destination *storage.NetworkRuleSet) error {
	...
	// Ipv6Rules
	if ruleSet.Ipv6Rules != nil {
		ipv6RuleList := make([]storage.IPRule, len(ruleSet.Ipv6Rules))
		for ipv6RuleIndex, ipv6RuleItem := range ruleSet.Ipv6Rules {
			var ipv6Rule storage.IPRule
			err := ipv6RuleItem.AssignProperties_To_IPRule(&ipv6Rule)
			if err != nil {
				return eris.Wrap(err, "calling AssignProperties_To_IPRule() to populate field Ipv6Rules")
			}
			ipv6RuleList[ipv6RuleIndex] = ipv6Rule
		}
		destination.Ipv6Rules = ipv6RuleList
	} else {
...
func (ruleSet *NetworkRuleSet) Initialize_From_NetworkRuleSet_STATUS(source *NetworkRuleSet_STATUS) error {
	...
	if source.Ipv6Rules != nil {
		...
		for ipv6RuleIndex, ipv6RuleItem := range source.Ipv6Rules {
			var ipv6Rule IPRule
			err := ipv6Rule.Initialize_From_IPRule_STATUS(&ipv6RuleItem)
			if err != nil {
				return eris.Wrap(err, "calling Initialize_From_IPRule_STATUS() to populate field Ipv6Rules")
			}
			ipv6RuleList[ipv6RuleIndex] = ipv6Rule
		}
		ruleSet.Ipv6Rules = ipv6RuleList
...
type NetworkRuleSet_STATUS struct {
	...
	// Ipv6Rules: Sets the IPv6 ACL rules.
	Ipv6Rules []IPRule_STATUS `json:"ipv6Rules,omitempty"`
...
func (ruleSet *NetworkRuleSet_STATUS) AssignProperties_From_NetworkRuleSet_STATUS(source *storage.NetworkRuleSet_STATUS) error {
	...
	// Ipv6Rules
	if source.Ipv6Rules != nil {
		ipv6RuleList := make([]IPRule_STATUS, len(source.Ipv6Rules))
		for ipv6RuleIndex, ipv6RuleItem := range source.Ipv6Rules {
			var ipv6Rule IPRule_STATUS
			err := ipv6Rule.AssignProperties_From_IPRule_STATUS(&ipv6RuleItem)
			if err != nil {
				return eris.Wrap(err, "calling AssignProperties_From_IPRule_STATUS() to populate field Ipv6Rules")
			}
			ipv6RuleList[ipv6RuleIndex] = ipv6Rule
		}
		ruleSet.Ipv6Rules = ipv6RuleList
...
func (ruleSet *NetworkRuleSet_STATUS) AssignProperties_To_NetworkRuleSet_STATUS(destination *storage.NetworkRuleSet_STATUS) error {
	...
	// Ipv6Rules
	if ruleSet.Ipv6Rules != nil {
		ipv6RuleList := make([]storage.IPRule_STATUS, len(ruleSet.Ipv6Rules))
		for ipv6RuleIndex, ipv6RuleItem := range ruleSet.Ipv6Rules {
			var ipv6Rule storage.IPRule_STATUS
			err := ipv6RuleItem.AssignProperties_To_IPRule_STATUS(&ipv6Rule)
			if err != nil {
				return eris.Wrap(err, "calling AssignProperties_To_IPRule_STATUS() to populate field Ipv6Rules")
			}
			ipv6RuleList[ipv6RuleIndex] = ipv6Rule
		}
		destination.Ipv6Rules = ipv6RuleList
...
var _ genruntime.ARMTransformer = &Placement{}

// ConvertToARM converts from a Kubernetes CRD object to an ARM object
func (placement *Placement) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	if placement == nil {
		return nil, nil
	}
	result := &arm.Placement{}

	// Set property "ZonePlacementPolicy":
	if placement.ZonePlacementPolicy != nil {
		var temp string
		temp = string(*placement.ZonePlacementPolicy)
		zonePlacementPolicy := arm.ZonePlacementPolicy(temp)
		result.ZonePlacementPolicy = &zonePlacementPolicy
	}
	return result, nil
}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (placement *Placement) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.Placement{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (placement *Placement) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.Placement)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.Placement, got %T", armInput)
	}

	// Set property "ZonePlacementPolicy":
	if typedInput.ZonePlacementPolicy != nil {
		var temp string
		temp = string(*typedInput.ZonePlacementPolicy)
		zonePlacementPolicy := ZonePlacementPolicy(temp)
		placement.ZonePlacementPolicy = &zonePlacementPolicy
	}
...
// AssignProperties_From_Placement populates our Placement from the provided source Placement
func (placement *Placement) AssignProperties_From_Placement(source *storage.Placement) error {

	// ZonePlacementPolicy
	if source.ZonePlacementPolicy != nil {
		zonePlacementPolicy := *source.ZonePlacementPolicy
		zonePlacementPolicyTemp := genruntime.ToEnum(zonePlacementPolicy, zonePlacementPolicy_Values)
		placement.ZonePlacementPolicy = &zonePlacementPolicyTemp
	} else {
		placement.ZonePlacementPolicy = nil
	}
...
// AssignProperties_To_Placement populates the provided destination Placement from our Placement
func (placement *Placement) AssignProperties_To_Placement(destination *storage.Placement) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	if placement.ZonePlacementPolicy != nil {
		...
		destination.ZonePlacementPolicy = &zonePlacementPolicy
	} else {
		destination.ZonePlacementPolicy = nil
	}
...
// Initialize_From_Placement_STATUS populates our Placement from the provided source Placement_STATUS
func (placement *Placement) Initialize_From_Placement_STATUS(source *Placement_STATUS) error {

	// ZonePlacementPolicy
	if source.ZonePlacementPolicy != nil {
		zonePlacementPolicy := genruntime.ToEnum(string(*source.ZonePlacementPolicy), zonePlacementPolicy_Values)
		placement.ZonePlacementPolicy = &zonePlacementPolicy
	} else {
		placement.ZonePlacementPolicy = nil
	}
...
var _ genruntime.FromARMConverter = &Placement_STATUS{}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (placement *Placement_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.Placement_STATUS{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (placement *Placement_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.Placement_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.Placement_STATUS, got %T", armInput)
	}
	...
	if typedInput.ZonePlacementPolicy != nil {
		var temp string
		temp = string(*typedInput.ZonePlacementPolicy)
		zonePlacementPolicy := ZonePlacementPolicy_STATUS(temp)
		placement.ZonePlacementPolicy = &zonePlacementPolicy
	}
...
// AssignProperties_From_Placement_STATUS populates our Placement_STATUS from the provided source Placement_STATUS
func (placement *Placement_STATUS) AssignProperties_From_Placement_STATUS(source *storage.Placement_STATUS) error {

	// ZonePlacementPolicy
	if source.ZonePlacementPolicy != nil {
		zonePlacementPolicy := *source.ZonePlacementPolicy
		zonePlacementPolicyTemp := genruntime.ToEnum(zonePlacementPolicy, zonePlacementPolicy_STATUS_Values)
		placement.ZonePlacementPolicy = &zonePlacementPolicyTemp
	} else {
		placement.ZonePlacementPolicy = nil
	}
...
// AssignProperties_To_Placement_STATUS populates the provided destination Placement_STATUS from our Placement_STATUS
func (placement *Placement_STATUS) AssignProperties_To_Placement_STATUS(destination *storage.Placement_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (preference *RoutingPreference) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if preference.RoutingChoice != nil {
		...
		routingChoice := arm.RoutingChoice(temp)
...
func (preference *RoutingPreference) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.RoutingChoice != nil {
		...
		routingChoice := RoutingChoice(temp)
...
func (preference *RoutingPreference) AssignProperties_From_RoutingPreference(source *storage.RoutingPreference) error {
	...
	if source.RoutingChoice != nil {
		...
		routingChoiceTemp := genruntime.ToEnum(routingChoice, routingChoice_Values)
...
func (preference *RoutingPreference) Initialize_From_RoutingPreference_STATUS(source *RoutingPreference_STATUS) error {
	...
	// RoutingChoice
	if source.RoutingChoice != nil {
		routingChoice := genruntime.ToEnum(string(*source.RoutingChoice), routingChoice_Values)
		preference.RoutingChoice = &routingChoice
	} else {
		preference.RoutingChoice = nil
	}
...
func (preference *RoutingPreference_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.RoutingChoice != nil {
		var temp string
		temp = string(*typedInput.RoutingChoice)
		routingChoice := RoutingChoice_STATUS(temp)
		preference.RoutingChoice = &routingChoice
	}
...
func (preference *RoutingPreference_STATUS) AssignProperties_From_RoutingPreference_STATUS(source *storage.RoutingPreference_STATUS) error {
	...
	if source.RoutingChoice != nil {
		routingChoice := *source.RoutingChoice
		routingChoiceTemp := genruntime.ToEnum(routingChoice, routingChoice_STATUS_Values)
		preference.RoutingChoice = &routingChoiceTemp
	} else {
		preference.RoutingChoice = nil
	}
...
func (status *StorageAccountSkuConversionStatus_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.SkuConversionStatus != nil {
		...
		skuConversionStatus := SkuConversionStatus_STATUS(temp)
...
func (status *StorageAccountSkuConversionStatus_STATUS) AssignProperties_From_StorageAccountSkuConversionStatus_STATUS(source *storage.StorageAccountSkuConversionStatus_STATUS) error {
	...
	if source.SkuConversionStatus != nil {
		...
		skuConversionStatusTemp := genruntime.ToEnum(skuConversionStatus, skuConversionStatus_STATUS_Values)
...
func (properties *AccountImmutabilityPolicyProperties) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if properties.State != nil {
		...
		state := arm.AccountImmutabilityPolicyState(temp)
		result.State = &state
	}
	return result, nil
}
...
func (properties *AccountImmutabilityPolicyProperties) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.State != nil {
		...
		state := AccountImmutabilityPolicyState(temp)
...
func (properties *AccountImmutabilityPolicyProperties) AssignProperties_From_AccountImmutabilityPolicyProperties(source *storage.AccountImmutabilityPolicyProperties) error {
	...
	if source.State != nil {
		state := *source.State
		stateTemp := genruntime.ToEnum(state, accountImmutabilityPolicyState_Values)
...
func (properties *AccountImmutabilityPolicyProperties) Initialize_From_AccountImmutabilityPolicyProperties_STATUS(source *AccountImmutabilityPolicyProperties_STATUS) error {
	...
	// State
	if source.State != nil {
		state := genruntime.ToEnum(string(*source.State), accountImmutabilityPolicyState_Values)
		properties.State = &state
	} else {
		properties.State = nil
	}
...
func (properties *AccountImmutabilityPolicyProperties_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.State != nil {
		var temp string
		temp = string(*typedInput.State)
		state := AccountImmutabilityPolicyState_STATUS(temp)
		properties.State = &state
	}
...
func (properties *AccountImmutabilityPolicyProperties_STATUS) AssignProperties_From_AccountImmutabilityPolicyProperties_STATUS(source *storage.AccountImmutabilityPolicyProperties_STATUS) error {
	...
	if source.State != nil {
		state := *source.State
		stateTemp := genruntime.ToEnum(state, accountImmutabilityPolicyState_STATUS_Values)
		properties.State = &stateTemp
	} else {
		properties.State = nil
	}
...
func (properties *ActiveDirectoryProperties) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if properties.AccountType != nil {
		...
		accountType := arm.AccountType(temp)
...
func (properties *ActiveDirectoryProperties) AssignProperties_From_ActiveDirectoryProperties(source *storage.ActiveDirectoryProperties) error {
	...
	if source.AccountType != nil {
		...
		accountTypeTemp := genruntime.ToEnum(accountType, accountType_Values)
...
func (properties *ActiveDirectoryProperties) Initialize_From_ActiveDirectoryProperties_STATUS(source *ActiveDirectoryProperties_STATUS) error {
	...
	// AccountType
	if source.AccountType != nil {
		accountType := genruntime.ToEnum(string(*source.AccountType), accountType_Values)
		properties.AccountType = &accountType
	} else {
		properties.AccountType = nil
	}
...
func (properties *ActiveDirectoryProperties_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.AccountType != nil {
		var temp string
		temp = string(*typedInput.AccountType)
		accountType := AccountType_STATUS(temp)
		properties.AccountType = &accountType
	}
...
func (properties *ActiveDirectoryProperties_STATUS) AssignProperties_From_ActiveDirectoryProperties_STATUS(source *storage.ActiveDirectoryProperties_STATUS) error {
	...
	if source.AccountType != nil {
		accountType := *source.AccountType
		accountTypeTemp := genruntime.ToEnum(accountType, accountType_STATUS_Values)
		properties.AccountType = &accountTypeTemp
	} else {
		properties.AccountType = nil
	}
...
type IPRule struct {
	...
	// ValueFromConfig: Specifies the IP or IP range in CIDR format.
...
var _ genruntime.ARMTransformer = &SmbOAuthSettings{}

// ConvertToARM converts from a Kubernetes CRD object to an ARM object
func (settings *SmbOAuthSettings) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	if settings == nil {
		return nil, nil
	}
	result := &arm.SmbOAuthSettings{}

	// Set property "IsSmbOAuthEnabled":
	if settings.IsSmbOAuthEnabled != nil {
		isSmbOAuthEnabled := *settings.IsSmbOAuthEnabled
		result.IsSmbOAuthEnabled = &isSmbOAuthEnabled
	}
	return result, nil
}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (settings *SmbOAuthSettings) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.SmbOAuthSettings{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (settings *SmbOAuthSettings) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.SmbOAuthSettings)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.SmbOAuthSettings, got %T", armInput)
	}

	// Set property "IsSmbOAuthEnabled":
	if typedInput.IsSmbOAuthEnabled != nil {
		isSmbOAuthEnabled := *typedInput.IsSmbOAuthEnabled
		settings.IsSmbOAuthEnabled = &isSmbOAuthEnabled
	}
...
// AssignProperties_From_SmbOAuthSettings populates our SmbOAuthSettings from the provided source SmbOAuthSettings
func (settings *SmbOAuthSettings) AssignProperties_From_SmbOAuthSettings(source *storage.SmbOAuthSettings) error {

	// IsSmbOAuthEnabled
	if source.IsSmbOAuthEnabled != nil {
		isSmbOAuthEnabled := *source.IsSmbOAuthEnabled
		settings.IsSmbOAuthEnabled = &isSmbOAuthEnabled
	} else {
		settings.IsSmbOAuthEnabled = nil
	}
...
// AssignProperties_To_SmbOAuthSettings populates the provided destination SmbOAuthSettings from our SmbOAuthSettings
func (settings *SmbOAuthSettings) AssignProperties_To_SmbOAuthSettings(destination *storage.SmbOAuthSettings) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	if settings.IsSmbOAuthEnabled != nil {
		isSmbOAuthEnabled := *settings.IsSmbOAuthEnabled
		destination.IsSmbOAuthEnabled = &isSmbOAuthEnabled
	} else {
		destination.IsSmbOAuthEnabled = nil
	}
...
// Initialize_From_SmbOAuthSettings_STATUS populates our SmbOAuthSettings from the provided source SmbOAuthSettings_STATUS
func (settings *SmbOAuthSettings) Initialize_From_SmbOAuthSettings_STATUS(source *SmbOAuthSettings_STATUS) error {
...
var _ genruntime.FromARMConverter = &SmbOAuthSettings_STATUS{}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (settings *SmbOAuthSettings_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.SmbOAuthSettings_STATUS{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (settings *SmbOAuthSettings_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.SmbOAuthSettings_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.SmbOAuthSettings_STATUS, got %T", armInput)
	}
...
// AssignProperties_From_SmbOAuthSettings_STATUS populates our SmbOAuthSettings_STATUS from the provided source SmbOAuthSettings_STATUS
func (settings *SmbOAuthSettings_STATUS) AssignProperties_From_SmbOAuthSettings_STATUS(source *storage.SmbOAuthSettings_STATUS) error {
...
// AssignProperties_To_SmbOAuthSettings_STATUS populates the provided destination SmbOAuthSettings_STATUS from our SmbOAuthSettings_STATUS
func (settings *SmbOAuthSettings_STATUS) AssignProperties_To_SmbOAuthSettings_STATUS(destination *storage.SmbOAuthSettings_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
var _ genruntime.FromARMConverter = &StorageAccountIpv6Endpoints_STATUS{}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (endpoints *StorageAccountIpv6Endpoints_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.StorageAccountIpv6Endpoints_STATUS{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (endpoints *StorageAccountIpv6Endpoints_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.StorageAccountIpv6Endpoints_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.StorageAccountIpv6Endpoints_STATUS, got %T", armInput)
	}
...
// AssignProperties_From_StorageAccountIpv6Endpoints_STATUS populates our StorageAccountIpv6Endpoints_STATUS from the provided source StorageAccountIpv6Endpoints_STATUS
func (endpoints *StorageAccountIpv6Endpoints_STATUS) AssignProperties_From_StorageAccountIpv6Endpoints_STATUS(source *storage.StorageAccountIpv6Endpoints_STATUS) error {
...
// AssignProperties_To_StorageAccountIpv6Endpoints_STATUS populates the provided destination StorageAccountIpv6Endpoints_STATUS from our StorageAccountIpv6Endpoints_STATUS
func (endpoints *StorageAccountIpv6Endpoints_STATUS) AssignProperties_To_StorageAccountIpv6Endpoints_STATUS(destination *storage.StorageAccountIpv6Endpoints_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (rule *VirtualNetworkRule) AssignProperties_From_VirtualNetworkRule(source *storage.VirtualNetworkRule) error {
	...
	if source.State != nil {
		state := *source.State
		stateTemp := genruntime.ToEnum(state, state_Values)
...
func (rule *VirtualNetworkRule) Initialize_From_VirtualNetworkRule_STATUS(source *VirtualNetworkRule_STATUS) error {
	...
	// State
	if source.State != nil {
		state := genruntime.ToEnum(string(*source.State), state_Values)
		rule.State = &state
	} else {
		rule.State = nil
	}
...
func (rule *VirtualNetworkRule_STATUS) AssignProperties_From_VirtualNetworkRule_STATUS(source *storage.VirtualNetworkRule_STATUS) error {
	...
	if source.State != nil {
		state := *source.State
		stateTemp := genruntime.ToEnum(state, state_STATUS_Values)
		rule.State = &stateTemp
	} else {
		rule.State = nil
	}
...
func (service *EncryptionService) AssignProperties_From_EncryptionService(source *storage.EncryptionService) error {
	...
	if source.KeyType != nil {
		...
		keyTypeTemp := genruntime.ToEnum(keyType, keyType_Values)
...
func (service *EncryptionService) Initialize_From_EncryptionService_STATUS(source *EncryptionService_STATUS) error {
	...
	// KeyType
	if source.KeyType != nil {
		keyType := genruntime.ToEnum(string(*source.KeyType), keyType_Values)
		service.KeyType = &keyType
	} else {
		service.KeyType = nil
	}
...
func (service *EncryptionService_STATUS) AssignProperties_From_EncryptionService_STATUS(source *storage.EncryptionService_STATUS) error {
	...
	if source.KeyType != nil {
		keyType := *source.KeyType
		keyTypeTemp := genruntime.ToEnum(keyType, keyType_STATUS_Values)
		service.KeyType = &keyTypeTemp
	} else {
		service.KeyType = nil
	}
