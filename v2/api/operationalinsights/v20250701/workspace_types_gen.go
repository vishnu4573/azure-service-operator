...
func (workspace *Workspace_Spec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if workspace.PublicNetworkAccessForIngestion != nil {
		...
		publicNetworkAccessForIngestion := arm.WorkspaceProperties_PublicNetworkAccessForIngestion(temp)
	...
	if workspace.PublicNetworkAccessForQuery != nil {
		...
		publicNetworkAccessForQuery := arm.WorkspaceProperties_PublicNetworkAccessForQuery(temp)
...
func (workspace *Workspace_Spec) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.PublicNetworkAccessForIngestion != nil {
			...
			publicNetworkAccessForIngestion := WorkspaceProperties_PublicNetworkAccessForIngestion(temp)
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.PublicNetworkAccessForQuery != nil {
			...
			publicNetworkAccessForQuery := WorkspaceProperties_PublicNetworkAccessForQuery(temp)
...
func (workspace *Workspace_Spec) AssignProperties_From_Workspace_Spec(source *storage.Workspace_Spec) error {
	...
	if source.PublicNetworkAccessForIngestion != nil {
		...
		publicNetworkAccessForIngestionTemp := genruntime.ToEnum(publicNetworkAccessForIngestion, workspaceProperties_PublicNetworkAccessForIngestion_Values)
	...
	if source.PublicNetworkAccessForQuery != nil {
		...
		publicNetworkAccessForQueryTemp := genruntime.ToEnum(publicNetworkAccessForQuery, workspaceProperties_PublicNetworkAccessForQuery_Values)
...
func (workspace *Workspace_Spec) Initialize_From_Workspace_STATUS(source *Workspace_STATUS) error {
	...
	// PublicNetworkAccessForIngestion
	if source.PublicNetworkAccessForIngestion != nil {
		publicNetworkAccessForIngestion := genruntime.ToEnum(string(*source.PublicNetworkAccessForIngestion), workspaceProperties_PublicNetworkAccessForIngestion_Values)
		workspace.PublicNetworkAccessForIngestion = &publicNetworkAccessForIngestion
	} else {
		workspace.PublicNetworkAccessForIngestion = nil
	}
	...
	// PublicNetworkAccessForQuery
	if source.PublicNetworkAccessForQuery != nil {
		publicNetworkAccessForQuery := genruntime.ToEnum(string(*source.PublicNetworkAccessForQuery), workspaceProperties_PublicNetworkAccessForQuery_Values)
		workspace.PublicNetworkAccessForQuery = &publicNetworkAccessForQuery
	} else {
		workspace.PublicNetworkAccessForQuery = nil
	}
...
func (workspace *Workspace_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.ProvisioningState != nil {
			...
			provisioningState := WorkspaceEntityStatus_STATUS(temp)
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.PublicNetworkAccessForIngestion != nil {
			var temp string
			temp = string(*typedInput.Properties.PublicNetworkAccessForIngestion)
			publicNetworkAccessForIngestion := WorkspaceProperties_PublicNetworkAccessForIngestion_STATUS(temp)
			workspace.PublicNetworkAccessForIngestion = &publicNetworkAccessForIngestion
		}
	}
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.PublicNetworkAccessForQuery != nil {
			var temp string
			temp = string(*typedInput.Properties.PublicNetworkAccessForQuery)
			publicNetworkAccessForQuery := WorkspaceProperties_PublicNetworkAccessForQuery_STATUS(temp)
			workspace.PublicNetworkAccessForQuery = &publicNetworkAccessForQuery
		}
	}
...
func (workspace *Workspace_STATUS) AssignProperties_From_Workspace_STATUS(source *storage.Workspace_STATUS) error {
	...
	if source.ProvisioningState != nil {
		...
		provisioningStateTemp := genruntime.ToEnum(provisioningState, workspaceEntityStatus_STATUS_Values)
	...
	if source.PublicNetworkAccessForIngestion != nil {
		publicNetworkAccessForIngestion := *source.PublicNetworkAccessForIngestion
		publicNetworkAccessForIngestionTemp := genruntime.ToEnum(publicNetworkAccessForIngestion, workspaceProperties_PublicNetworkAccessForIngestion_STATUS_Values)
		workspace.PublicNetworkAccessForIngestion = &publicNetworkAccessForIngestionTemp
	} else {
		workspace.PublicNetworkAccessForIngestion = nil
	}
	...
	if source.PublicNetworkAccessForQuery != nil {
		publicNetworkAccessForQuery := *source.PublicNetworkAccessForQuery
		publicNetworkAccessForQueryTemp := genruntime.ToEnum(publicNetworkAccessForQuery, workspaceProperties_PublicNetworkAccessForQuery_STATUS_Values)
		workspace.PublicNetworkAccessForQuery = &publicNetworkAccessForQueryTemp
	} else {
		workspace.PublicNetworkAccessForQuery = nil
	}
...
func (capping *WorkspaceCapping_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.DataIngestionStatus != nil {
		...
		dataIngestionStatus := DataIngestionStatus_STATUS(temp)
...
func (capping *WorkspaceCapping_STATUS) AssignProperties_From_WorkspaceCapping_STATUS(source *storage.WorkspaceCapping_STATUS) error {
	...
	if source.DataIngestionStatus != nil {
		...
		dataIngestionStatusTemp := genruntime.ToEnum(dataIngestionStatus, dataIngestionStatus_STATUS_Values)
...
func (properties *WorkspaceFailoverProperties_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.State != nil {
		...
		state := WorkspaceFailoverState_STATUS(temp)
...
func (properties *WorkspaceFailoverProperties_STATUS) AssignProperties_From_WorkspaceFailoverProperties_STATUS(source *storage.WorkspaceFailoverProperties_STATUS) error {
	...
	if source.State != nil {
		state := *source.State
		stateTemp := genruntime.ToEnum(state, workspaceFailoverState_STATUS_Values)
...
func (properties *WorkspaceReplicationProperties_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.ProvisioningState != nil {
		...
		provisioningState := WorkspaceReplicationState_STATUS(temp)
...
func (properties *WorkspaceReplicationProperties_STATUS) AssignProperties_From_WorkspaceReplicationProperties_STATUS(source *storage.WorkspaceReplicationProperties_STATUS) error {
	...
	if source.ProvisioningState != nil {
		provisioningState := *source.ProvisioningState
		provisioningStateTemp := genruntime.ToEnum(provisioningState, workspaceReplicationState_STATUS_Values)
...
func (workspaceSku *WorkspaceSku) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if workspaceSku.Name != nil {
		...
		name := arm.WorkspaceSkuNameEnum(temp)
		result.Name = &name
	}
	return result, nil
}
...
func (workspaceSku *WorkspaceSku) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Name != nil {
		...
		name := WorkspaceSkuNameEnum(temp)
...
func (workspaceSku *WorkspaceSku) AssignProperties_From_WorkspaceSku(source *storage.WorkspaceSku) error {
	...
	if source.Name != nil {
		name := *source.Name
		nameTemp := genruntime.ToEnum(name, workspaceSkuNameEnum_Values)
...
func (workspaceSku *WorkspaceSku) Initialize_From_WorkspaceSku_STATUS(source *WorkspaceSku_STATUS) error {
	...
	// Name
	if source.Name != nil {
		name := genruntime.ToEnum(string(*source.Name), workspaceSkuNameEnum_Values)
		workspaceSku.Name = &name
	} else {
		workspaceSku.Name = nil
	}
...
func (workspaceSku *WorkspaceSku_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Name != nil {
		var temp string
		temp = string(*typedInput.Name)
		name := WorkspaceSkuNameEnum_STATUS(temp)
		workspaceSku.Name = &name
	}
...
func (workspaceSku *WorkspaceSku_STATUS) AssignProperties_From_WorkspaceSku_STATUS(source *storage.WorkspaceSku_STATUS) error {
	...
	if source.Name != nil {
		name := *source.Name
		nameTemp := genruntime.ToEnum(name, workspaceSkuNameEnum_STATUS_Values)
		workspaceSku.Name = &nameTemp
	} else {
		workspaceSku.Name = nil
	}
