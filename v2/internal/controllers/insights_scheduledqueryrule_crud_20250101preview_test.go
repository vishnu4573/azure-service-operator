...
import (
	...
	insights "github.com/Azure/azure-service-operator/v2/api/insights/v1api20250101preview"
...
func Test_Insights_ScheduledQueryRule_20250101preview_CRUD(t *testing.T) {
	t.Parallel()
