...
func (profile *ManagedClusterAADProfile_STATUS) AssignProperties_From_ManagedClusterAADProfile_STATUS(source *storage.ManagedClusterAADProfile_STATUS) error {
	...
	// ServerAppSecret
	if source.ServerAppSecret != nil {
		propertyBag.Add("ServerAppSecret", *source.ServerAppSecret)
	} else {
		propertyBag.Remove("ServerAppSecret")
	}
...
func (profile *ManagedClusterAADProfile_STATUS) AssignProperties_To_ManagedClusterAADProfile_STATUS(destination *storage.ManagedClusterAADProfile_STATUS) error {
	...
	// ServerAppSecret
	if propertyBag.Contains("ServerAppSecret") {
		var serverAppSecret string
		err := propertyBag.Pull("ServerAppSecret", &serverAppSecret)
		if err != nil {
			return eris.Wrap(err, "pulling 'ServerAppSecret' from propertyBag")
		}
