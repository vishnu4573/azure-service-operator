...
func (extension *Extension_Spec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if extension.ConfigurationProtectedSettings != nil {
		result.Properties.ConfigurationProtectedSettings = make(map[string]string, len(extension.ConfigurationProtectedSettings))
		for key, value := range extension.ConfigurationProtectedSettings {
			result.Properties.ConfigurationProtectedSettings[key] = value
		}
	}
